...
namespace MtrxSys.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260715130055_AddOwnedGroupDispatchExemption")]
    partial class AddOwnedGroupDispatchExemption
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MtrxSys.Core.Domain.Groups.OwnedGroup", b =>
                {
                    ...
                    b.Property<string>("WaGroupId")
                        .IsRequired()
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
                        .HasColumnName("wa_group_id");

                    b.HasKey("Id");

                    b.HasIndex("WaGroupId")
                        .IsUnique();
